...
INSERT INTO orders VALUES
    ...
    (1010, "c0", DATETIME("now", "-5 days"), "Not Edmonton"),
    (1011, "c0", DATETIME("now", "-2 days"), "Not Edmonton"),
    (1020, "c0", DATETIME("now", "-6 days"), "Chez Puck"),
    (1021, "c0", DATETIME("now", "-1 days"), "Chez Puck"),
    (1030, "c0", DATETIME("now", "-3 days"), "Everywhere"),
    (1031, "c0", DATETIME("now", "-2 days"), "Everywhere"),
    (1040, "c0", DATETIME("now", "-13 days"), "Middle of the Ocean"),
    (1041, "c0", DATETIME("now", "-5 days"), "Middle of the Ocean"),
    (1050, "c0", DATETIME("now", "-7 days"), "On a Farm"),
    (1051, "c0", DATETIME("now", "-1 days"), "On a Farm"),
